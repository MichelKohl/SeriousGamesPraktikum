...
/// <summary>
/// source: https://www.nuf.dk/making-unity-colliders-follow-the-screensize/
/// </summary>
public class CreateScreenColliders : MonoBehaviour
{
    ...
    IEnumerator CreateColliders()
    {
        ...
        screenSize.x = Vector3.Distance(Camera.main.ScreenToWorldPoint(new Vector2(0, 0)), Camera.main.ScreenToWorldPoint(new Vector2(Screen.width, 0))) * 0.5f;
        screenSize.y = Vector2.Distance(Camera.main.ScreenToWorldPoint(new Vector2(0, 0)), Camera.main.ScreenToWorldPoint(new Vector2(0, Screen.height))) * 0.5f;
        Debug.Log(Camera.main.ScreenToWorldPoint(new Vector2(Screen.width, 0)));
        ...
        colliders["Right"].position = new Vector3(cameraPos.x + screenSize.x + (colliders["Right"].localScale.x * 0.5f), 0, cameraPos.y);
